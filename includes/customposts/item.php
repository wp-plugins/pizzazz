...
class Item {
    ...
    public function addItemListHeader() {
        ...
        $message = '<div class="updated survey-link"><p>We are working on a premium version of Pizzazz, take our';
        $message .= ' <a href="http://bluebridgedev.com/pizzazz-survey" target="_blank">three question survey</a>';
        $message .= ' for a chance to win a free copy when it is released.</p></div>';
        echo $message;
    }
}